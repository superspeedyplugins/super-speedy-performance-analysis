...
<div class="sspa-placeholder">
    ...
    <p><?php esc_html_e('With consent version 5, profiling runs also share bounded plugin include timings, selected hook and callback timings, render summaries and script/style counts attributed to plugins. Custom hook names and callback file paths are excluded. These summaries do not claim to cover every callback. Passive traffic and AJAX observation windows remain local.', 'super-speedy-performance-analysis'); ?></p>
...
<div class="sspa-placeholder">
    ...
    <pre class="sspa-payload-preview" style="display:none"></pre>
    <p class="description">
