...
for check in browser-transport loopback-fallback quick-comparison admin-journey measurement measurement-error report-panels report-mobile history-mobile admin-mobile tab-retry shared-link translations checkout-flow traffic-workflow sharing; do
