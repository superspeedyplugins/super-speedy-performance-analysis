...
for check in browser-transport loopback-fallback quick-comparison admin-journey measurement measurement-error report-panels report-mobile history-mobile checkout-flow traffic-workflow sharing; do
