...
sspa_backfill_t(false !== strpos($share_html, 'sspa-preview-outbox') && false !== strpos($share_html, 'schema 1.1'), 'Share tab exposes exact-payload controls and versioned rows');
